...
#                                              +#+#+#+#+#+   +#+            #
#  Created: 2026/05/12 17:00:14 by vsack           #+#    #+#               #
#  Updated: 2026/05/27 19:10:18 by vsack           ###   ########.fr        #
#                                                                           #
# ************************************************************************* #
...
if __name__ == "__main__":
    ...
    print(f"Built list of 10 events: {tupleEvents}")
    for event in consume_event(tupleEvents):
        print(f"Got event from list: {event}")
        print(f"Remains in list: {tupleEvents}")
